...
If it's not already open, [expand](expand-or-collapse-cedar-form-section.md) the Human Subject Applicablity section on your CEDAR form. This section has six fields; click below to expand guidance for each field. 
...
Once complete, [save](save-cedar-form.md) your form, and [collapse](expand-or-collapse-cedar-form-section.md) the Human Subject Applicability section.
